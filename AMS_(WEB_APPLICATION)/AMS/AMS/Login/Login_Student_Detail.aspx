                ...
                <table id="Table3" runat="server" width="0%" cellpadding="5" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <asp:RequiredFieldValidator ID="rfv_dob" runat="server" ErrorMessage="*Required" ControlToValidate="txt_dob" Display="Dynamic" CssClass="error_label_red"></asp:RequiredFieldValidator>
                    ...
                    <%--<tr>
                        ...
                        <td align="left">
                            <asp:DropDownList ID="ddl_country" runat="server" AutoPostBack="true" ToolTip="Country" OnSelectedIndexChanged="ddl_country_SelectedIndexChanged"></asp:DropDownList>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <asp:RequiredFieldValidator ID="rfv_line1" runat="server" ErrorMessage="*Required" ControlToValidate="txt_line1" Display="Dynamic" CssClass="error_label_red"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td align="left">
                            ...
                            <%--<asp:RequiredFieldValidator ID="rfv_line2" runat="server" ErrorMessage="*Required" ControlToValidate="txt_line2" Display="Dynamic" CssClass="error_label_red"></asp:RequiredFieldValidator>--%>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td align="left">
                            ...
                            <asp:RequiredFieldValidator ID="rfv_city" runat="server" ErrorMessage="*Required" ControlToValidate="txt_city" Display="Dynamic" CssClass="error_label_red"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td align="left">
                            ...
                            <asp:RequiredFieldValidator ID="rfv_state" runat="server" ErrorMessage="*Required" ControlToValidate="txt_state" Display="Dynamic" CssClass="error_label_red"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                        ...
                        <td align="left">
                            ...
                            <asp:RequiredFieldValidator ID="rfv_pincode" runat="server" ErrorMessage="*Required" ControlToValidate="txt_pincode" Display="Dynamic" CssClass="error_label_red"></asp:RequiredFieldValidator>
                   ...
                   <%-- <tr>
                        ...
                        <td align="left">
                            ...
                            <asp:RequiredFieldValidator ID="rfv_relationship_status" runat="server" ErrorMessage="*Required" ControlToValidate="ddl_relationship_status" Display="Dynamic" CssClass="error_label_red"></asp:RequiredFieldValidator>
                        </td>
                    </tr>--%>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <asp:RegularExpressionValidator ID="rev_landline" runat="server" ControlToValidate="txt_landline" Display="Dynamic" ErrorMessage="*Incorrect" ValidationExpression="^[+]?(\d{0})?(\d{10,14})?$" CssClass="error_label_orange"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                            <asp:Label ID="lbl_conpany_name" runat="server" Text="Course Name :"></asp:Label>
                        </td>
                        <td align="left">
                            <asp:TextBox ID="txt_company_name" runat="server" ToolTip="Course Name" MaxLength="50"></asp:TextBox>
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="lbl_designation" runat="server" Text="Instrument :"></asp:Label>
                        </td>
                        <td align="left">
                            <asp:TextBox ID="txt_designation" runat="server" ToolTip="Instrument" MaxLength="50"></asp:TextBox>
