...
namespace CN.Tags
{
    public class tag_function
    {
        ...
        public static void ddl_bind(DropDownList ddl_id)
        {
            ...
            ddl_id.DataTextField = ds.Tables[0].Columns[1].ColumnName;
            ddl_id.DataValueField = ds.Tables[0].Columns[0].ColumnName;
            ddl_id.Visible = (bool)ds.Tables[0].Rows[0][2];
            ddl_id.DataBind();
            ds.Clear();
            ddl_id.Dispose();
        }
        ...
        public static void ddl_bind_selected_value_textbox(TextBox txt_id, string selected_value)
        {
            DataSet ds = business_function.dropdown_tag_selected_value(txt_id.ID.ToString(), selected_value);
            if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count == 1)
            {
                txt_id.Text = ds.Tables[0].Rows[0]["ddl_text"].ToString();
            }
        }
    }
}