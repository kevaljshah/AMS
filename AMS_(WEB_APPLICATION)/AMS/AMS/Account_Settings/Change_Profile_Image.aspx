<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Pages/MasterPage.master" AutoEventWireup="true" CodeFile="Change_Profile_Image.aspx.cs" Inherits="Members_Add_Member" %>
        ...
        <tr>
            <td align="center">
                <table id="Table3" runat="server" width="50%" cellpadding="5" cellspacing="0">
                    ...
                    <tr>
                        <td align="center">
                            <asp:Button ID="btn_remove" runat="server" Text="Remove" CausesValidation="false" ToolTip="Remove" TabIndex="3" OnClick="btn_remove_Click" />
                            <asp:Button ID="btn_upload" runat="server" Text="Upload" CausesValidation="true" ToolTip="Upload" OnClick="btn_upload_Click" TabIndex="2" Style="margin-left: 5%;" />
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
