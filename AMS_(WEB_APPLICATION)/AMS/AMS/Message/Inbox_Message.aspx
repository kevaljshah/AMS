<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Pages/MasterPage.master" AutoEventWireup="true" CodeFile="Inbox_Message.aspx.cs" Inherits="Members_View_Members" %>
        ...
        <tr>
            <td align="center">
                <asp:GridView ID="gv_inbox_message" runat="server" AllowPaging="true" OnPageIndexChanging="gv_inbox_message_PageIndexChanging" AutoGenerateColumns="false" Width="100%" PageSize="20"
                    ...
                    <Columns>
                        <asp:HyperLinkField HeaderText="Message From" DataTextField="name" DataNavigateUrlFields="sap_id,page_name" DataNavigateUrlFormatString="~/Message/Reply_Message.aspx?sap_id={0}&page_name={1}"
