...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_body" runat="Server">
    <table id="Table1" runat="server" width="100%" cellspacing="20" cellpadding="0">
                            ...
                            <table id="Table4" runat="server" width="100%" cellpadding="10" cellspacing="0">
                                <tr>
                                    ...
                                    <td align="left" width="60%">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfv_gr_no" runat="server" ErrorMessage="*Required" ControlToValidate="txt_gr_no" Display="Dynamic" ForeColor="#AE1213"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="rev_gr_no" runat="server" ControlToValidate="txt_gr_no" Display="Dynamic" ErrorMessage="*Incorrect" ForeColor="#FF6600" ValidationExpression="^[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]$"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="40%">
                                ...
                                <tr>
                                    ...
                                    <td align="left" width="60%">
                                        <asp:DropDownList ID="ddl_program" runat="server" AutoPostBack="True" OnTextChanged="ddl_program_TextChanged"></asp:DropDownList>
                            ...
                            <table id="Table5" runat="server" width="100%" cellpadding="10" cellspacing="0">
                                <tr>
                                    ...
                                    <td align="left" width="60%">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfv_roll_no" runat="server" ErrorMessage="*Required" ControlToValidate="txt_roll_no" Display="Dynamic" ForeColor="#AE1213"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="rev_roll_no" runat="server" ControlToValidate="txt_roll_no" Display="Dynamic" ErrorMessage="*Incorrect" ForeColor="#FF6600" ValidationExpression="^[A-Z]?[0-9][0-9][0-9]$"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="40%">
                                    ...
                                    <td align="left" width="60%">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfv_division" runat="server" ErrorMessage="*Required" ControlToValidate="ddl_division" Display="Dynamic" ForeColor="#AE1213"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="40%">
        ...
        <tr align="center" style="border-bottom-style: solid; border-width: 1px; border-color: #585A59;">
            <td style="border-top-style: solid; border-width: 1px; border-color: #585A59; padding: 10px; padding-left: 20px; padding-right: 10px;">
                <asp:Button ID="btn_add" runat="server" Text="Save" OnClick="btn_add_Click" />
    ...
    <table id="Table10" runat="server" width="100%" cellpadding="0" visible="false">
        ...
        <tr>
            <td colspan="2" align="center">
                <asp:Button ID="btn_back_error" runat="server" Text="Back" OnClick="btn_back_Click" />
            </td>
        </tr>
    </table>
</asp:Content>
