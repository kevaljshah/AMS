<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/Master_Pages/Login_Master.master" AutoEventWireup="true" CodeFile="Change_Student_Details.aspx.cs" Inherits="Members_Add_Member" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_body" runat="Server">
    <table runat="server" width="100%" cellspacing="0" cellpadding="0" visible="true">
        <tr>
    ...
    <asp:Accordion ID="accordian_account_detail" runat="Server" AutoSize="None" FadeTransitions="true" TransitionDuration="250" FramesPerSecond="40" RequireOpenedPane="false"
        SuppressHeaderPostbacks="true"  SelectedIndex="-1" HeaderCssClass="accordion_header" HeaderSelectedCssClass="accordion_selected_header" ContentCssClass="accordion_content">
        <Panes>
                        ...
                        <table id="Table2" runat="server" width="100%" cellspacing="10" cellpadding="0">
                            <tr>
                                ...
                                <td style="text-align:left">
                                    <asp:TextBox ID="txt_first_name" Width="95%" runat="server" ValidationGroup="vg_personal_details" TabIndex="1"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td style="text-align:left">
                                    <asp:TextBox ID="txt_middle_name"  Width="95%"  runat="server" ValidationGroup="vg_personal_details" TabIndex="2"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td style="text-align:left">
                                    <asp:TextBox ID="txt_last_name"  Width="95%" runat="server" ValidationGroup="vg_personal_details" TabIndex="3"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td style="text-align:left">
                                    <asp:TextBox ID="txt_dob"  Width="95%" runat="server" Style="text-align: center;" ToolTip="Birthdate" ReadOnly="true" ValidationGroup="vg_personal_details" TabIndex="4"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td style="text-align:left">
                                    <asp:DropDownList ID="ddl_gender" Width="95%"  runat="server" ToolTip="Gender" ValidationGroup="vg_personal_details" TabIndex="5"></asp:DropDownList>
                            ...
                            <tr>
                                ...
                                <td style="text-align:left">
                                    <asp:DropDownList ID="ddl_relationship_status" Width="95%" runat="server" ValidationGroup="vg_personal_details" TabIndex="6"></asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                            
                                <td style="text-align:left">
                                    <asp:TextBox ID="txt_company_name" Width="95%" runat="server" ValidationGroup="vg_personal_details" TabIndex="7"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td style="text-align:left">
                                    <asp:TextBox ID="txt_designation" runat="server" Width="95%" ValidationGroup="vg_personal_details" TabIndex="8"></asp:TextBox>
                            ...
                            <tr>
                                <td align="right" width="50%">
                                    <asp:Button ID="btn_personal_details_cancel" runat="server" Text="Cancel" style="background-color:#AE1213;color:white;" Width="100%" CausesValidation="false" OnClick="btn_cancel_Click" TabIndex="10" />
                                </td>
                                </tr>
                            <tr>
                                <td align="left" width="50%">
                                    <asp:Button ID="btn_personal_details_save" runat="server" Text="Save" style="background-color:#AE1213;color:white;" Width="100%" CausesValidation="true" ValidationGroup="vg_personal_details" OnClick="btn_personal_details_save_Click" TabIndex="9" />
                    ...
                    <asp:Panel ID="pn_contact_details" runat="server" DefaultButton="btn_contact_details_save">
                        <table id="Table3" runat="server" width="100%" cellspacing="10" cellpadding="0">
                            <tr>
                                ...
                                <td style="text-align:left">
                                    <asp:TextBox ID="txt_email" runat="server" Width="95%" ToolTip="Email-ID" MaxLength="50" ValidationGroup="vg_contact_details" TabIndex="1"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td style="text-align:left">
                                    ...
                                    <asp:TextBox ID="txt_mobile" runat="server"  ToolTip="Mobile" MaxLength="50" ValidationGroup="vg_contact_details" TabIndex="3"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td style="text-align:left">
                                    <asp:TextBox ID="txt_landline" runat="server" Width="95%" ToolTip="Landline" ValidationGroup="vg_contact_details" TabIndex="4"></asp:TextBox>
                            ...
                            <tr>
                                <td style="text-align:left">
                                    <asp:Button ID="btn_contact_details_cancel" runat="server" style="background-color:#AE1213;color:white;" Width="100%" Text="Cancel" CausesValidation="false" OnClick="btn_cancel_Click" TabIndex="6" />
                                </td>
                                </tr>
                            <tr>
                                <td style="text-align:left">
                                    <asp:Button ID="btn_contact_details_save" runat="server" Text="Save"  CausesValidation="true" ValidationGroup="vg_contact_details" OnClick="btn_contact_details_save_Click" TabIndex="5" />
                    ...
                    <asp:Panel ID="pn_mailing_address" runat="server" DefaultButton="btn_mailing_address_save">
                        <table id="Table4" runat="server" width="100%" cellspacing="10" cellpadding="0">
                            <tr>
                                ...
                                <td style="text-align:left">
                                    <asp:DropDownList ID="ddl_country" runat="server" Width="95%" ToolTip="Country" ValidationGroup="vg_mailing_address" TabIndex="1"></asp:DropDownList>
                            ...
                            <tr>
                                ...
                                <td style="text-align:left">
                                    <asp:TextBox ID="txt_line1" runat="server" Width="95%" ToolTip="Address Line" MaxLength="50" ValidationGroup="vg_mailing_address" TabIndex="2"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td style="text-align:left">
                                    <asp:TextBox ID="txt_line2" runat="server" Width="95%" ValidationGroup="vg_mailing_address" TabIndex="3"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td style="text-align:left">
                                    <asp:TextBox ID="txt_city" runat="server" ToolTip="City" Width="95%" MaxLength="50" ValidationGroup="vg_mailing_address" TabIndex="4"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td style="text-align:left">
                                    <asp:TextBox ID="txt_state" runat="server" Width="95%" ToolTip="State/Province" MaxLength="50" ValidationGroup="vg_mailing_address" TabIndex="5"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td style="text-align:left">
                                    <asp:TextBox ID="txt_pincode" runat="server" Width="95%" ToolTip="Zip/Postal Code" MaxLength="50" ValidationGroup="vg_mailing_address" TabIndex="6"></asp:TextBox>
                            ...
                            <tr>
                                <td style="text-align:left">
                                    <asp:Button ID="btn_mailing_address_cancel" style="background-color:#AE1213;color:white;" Width="100%" runat="server" Text="Cancel"  CausesValidation="false" OnClick="btn_cancel_Click" TabIndex="8" />
                                </td>
                                </tr>
                            <tr>
                                <td style="text-align:left">
                                    <asp:Button ID="btn_mailing_address_save" style="background-color:#AE1213;color:white;" Width="100%" runat="server" Text="Save"  CausesValidation="true" OnClick="btn_mailing_address_save_Click" ValidationGroup="vg_mailing_address" TabIndex="7" />
                ...
                <Content>
                    <asp:Panel ID="pn_username" runat="server" DefaultButton="btn_username_save">
                        <table id="Table1" runat="server" width="100%" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td style="text-align:left">
                                    <asp:TextBox ID="txt_username" runat="server" Width="95%" MaxLength="50" ToolTip="Username" ValidationGroup="vg_username"></asp:TextBox>
                            ...
                            <tr>
                                <td style="text-align:left">
                                    <asp:Button ID="btn_username_cancel" runat="server" Text="Cancel"  CausesValidation="false" OnClick="btn_cancel_Click" style="background-color:#AE1213;color:white;" Width="100%"/>
                                </td>
                                </tr>
                            <tr>
                                <td align="left" width="50%">
                                    <asp:Button ID="btn_username_save" runat="server" Text="Save"  CausesValidation="true" ValidationGroup="vg_username" OnClick="btn_username_save_Click" style="background-color:#AE1213;color:white;" Width="100%" />
            ...
            <asp:AccordionPane ID="ap_password" runat="server">
                ...
                <Content>
                    <asp:Panel ID="pn_password" runat="server" DefaultButton="btn_password_save">
                        <table id="Table5" runat="server" width="100%" cellspacing="0" cellpadding="0">
                            <tr>
                                <td style="text-align:left">
                            ...
                            <tr>
                                <td style="text-align:left">
                                    <input type="password" id="txt_current_password" runat="server" placeholder="Current Password" maxlength="50" title="Current Password" style="width:95%"/>
                            ...
                            <tr>
                                <td style="text-align:left">
                                    <asp:TextBox ID="txt_new_password" runat="server" ToolTip="Password" MaxLength="50" ValidationGroup="vg_password" TabIndex="2" Width="95%"></asp:TextBox>
                            ...
                            <tr>
                                <td style="text-align:left">
                                    <asp:TextBox ID="txt_confirm_password" runat="server" ToolTip="Confirm Password" MaxLength="50" ValidationGroup="vg_password" TabIndex="3" Width="95%"></asp:TextBox>
                            ...
                            <tr>
                                <td>
                                    <asp:Button ID="btn_password_cancel" runat="server" Text="Cancel"  CausesValidation="false" OnClick="btn_cancel_Click" style="background-color:#AE1213;color:white;" Width="100%"/>
                                </td>
                                </tr>
                            <tr>
                                <td>
                                    <asp:Button ID="btn_password_save" runat="server" Text="Save"  CausesValidation="true" ValidationGroup="vg_password" OnClick="btn_password_save_Click" TabIndex="4" style="background-color:#AE1213;color:white;" Width="100%" />
