<%@ Page Title="" Language="C#" MasterPageFile="~/mobile/Master_Pages/Login_Master.master" AutoEventWireup="true" CodeFile="Send_Message.aspx.cs" Inherits="Message_Send_Message" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_body" runat="Server">
    <table id="Table1" runat="server" width="100%" cellspacing="0" cellpadding="0">
        <tr>
            <td align="left" style="border-bottom-style: solid; border-bottom-width: 2px; border-color: #585A59;" class="auto-style1">
        ...
        <tr>
            <td width="100%">
                <table id="Table2" runat="server" width="100%" cellpadding="0" cellspacing="0">
                    <tr align="left">
                        <td>
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:TextBox ID="txt_send_message_to" runat="server" Width="95%" OnTextChanged="txt_send_message_to_TextChanged" AutoPostBack="true"></asp:TextBox>
