...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_body" runat="Server">
    <table id="Table1" runat="server" width="100%" cellspacing="20" cellpadding="0">
         <tr>
            <td align="left" style="border-bottom-style: solid; border-bottom-width: 2px; border-color: #585A59;">
                <asp:Label ID="lbl_create_newsletter" runat="server" Text="Create Newsletter" CssClass="page_header"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="left">
                <asp:Accordion ID="accordion" runat="Server" AutoSize="None" FadeTransitions="true" TransitionDuration="250" FramesPerSecond="40" RequireOpenedPane="false"
                    SuppressHeaderPostbacks="true" Height="100%" Width="100%" SelectedIndex="-1" HeaderCssClass="accordion_header" HeaderSelectedCssClass="accordion_selected_header" ContentCssClass="accordion_content">
                    <Panes>
                        <asp:AccordionPane ID="AccordionPane1" runat="server">
                            <Header>
                                <asp:Label ID="lbl_group" runat="server" Text="Group" ForeColor="#AE1213" Font-Size="Large"></asp:Label>
                            </Header>
                            <Content>
    ...
    <table id="Table3" runat="server" width="100%" cellspacing="20" visible="false">
        ...
        <tr>
            <td align="center">
                <asp:GridView ID="gv_success" runat="server" AutoGenerateColumns="false" Width="100%" RowStyle-HorizontalAlign="Center">
                    <Columns>
                        <asp:BoundField HeaderText="Email ID" DataField="email_id" ItemStyle-Width="33%" />
                        <asp:BoundField HeaderText="GR No" DataField="gr_no" ItemStyle-Width="33%" />
    ...
    <table id="Table4" runat="server" width="100%" cellspacing="20" visible="false">
        ...
        <tr>
            <td align="center">
                <asp:GridView ID="gv_fail" runat="server" AutoGenerateColumns="false" Width="100%" RowStyle-HorizontalAlign="Center">
                    <Columns>
                        <asp:BoundField HeaderText="Email ID" DataField="email_id" ItemStyle-Width="33%" />
                        <asp:BoundField HeaderText="Gr No" DataField="gr_no" ItemStyle-Width="33%" />
                        <asp:BoundField HeaderText="Name" DataField="name" ItemStyle-Width="33%" />
