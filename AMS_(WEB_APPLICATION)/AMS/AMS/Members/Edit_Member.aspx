<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Pages/MasterPage.master" AutoEventWireup="true" CodeFile="Edit_Member.aspx.cs" Inherits="Members_Edit_Member" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_body" runat="Server">
    <table id="tbl_edit_member" runat="server" width="100%" cellspacing="20" cellpadding="0">
        <tr>
            <td align="left" style="border-bottom-style: solid; border-bottom-width: 2px; border-color: #585A59;">
                <asp:Label ID="lbb_add_member" runat="server" Text="Edit Member Details" CssClass="page_header"></asp:Label>
            </td>
        </tr>
        <tr align="left">
            <td class="table_headercell">
                <asp:Label ID="lbl_search_student_header" runat="server" Text="Search Member:"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table id="Table1" runat="server" cellpadding="10" cellspacing="0" width="100%">
                    <tr>
                        <td align="right" width="20%">
                            <asp:Label ID="lbl_search_student" runat="server" Text=" Search Student :"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBoxWatermarkExtender ID="wm_edit_member" runat="server" TargetControlID="txt_edit_member" WatermarkCssClass="textboxwatermark_left"></asp:TextBoxWatermarkExtender>
                            <asp:AutoCompleteExtender ID="ace_edit_member" runat="server" TargetControlID="txt_edit_member" EnableCaching="true"
                                ServiceMethod="GetDetails" ShowOnlyCurrentWordInCompletionListItem="true" UseContextKey="True" MinimumPrefixLength="1"
                                FirstRowSelected="true" CompletionInterval="500" OnClientItemSelected="ace_edit_member_selected">
                            </asp:AutoCompleteExtender>
                            <asp:TextBox ID="txt_edit_member" runat="server" OnTextChanged="txt_edit_member_TextChanged" AutoPostBack="true" Width="50%"></asp:TextBox>
                            <asp:Label ID="lbl_edit_member_error" runat="server" Visible="false" CssClass="error_label_red"></asp:Label>
                            <asp:HiddenField ID="hf_edit_member" runat="server" />
                        </td>
                    </tr>
                </table>
            </td>
                            ...
                            <table id="Table4" runat="server" width="100%" cellpadding="10" cellspacing="0">
                                <tr>
                                    ...
                                    <td align="left" width="60%">
                                        <asp:TextBox ID="txt_gr_no" runat="server"></asp:TextBox>
                                        ...
                                        <asp:RegularExpressionValidator ID="rev_gr_no" runat="server" ControlToValidate="txt_gr_no" Display="Dynamic" ErrorMessage="*Incorrect" CssClass="error_label_orange" ValidationExpression="^[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]$"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="40%">
                                ...
                                <tr>
                                    ...
                                    <td align="left" width="60%">
                                        <asp:DropDownList ID="ddl_program" runat="server" OnSelectedIndexChanged="ddl_program_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList>
            ...
            <td>
                <table id="Table6" runat="server" cellpadding="10" cellspacing="0" width="50%">
                    <tr>
                        ...
                        <td align="left" width="60%">
                            <asp:TextBox ID="txt_dob" runat="server" Style="text-align: center;" ToolTip="Birthdate" ReadOnly="true"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfv_dob" runat="server" ErrorMessage="*Required" ControlToValidate="txt_dob" Display="Dynamic" CssClass="error_label_red" Enabled="false"></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td align="left" width="60%">
                            ...
                            <asp:RequiredFieldValidator ID="rfv_relationship_status" runat="server" ErrorMessage="*Required" ControlToValidate="ddl_relationship_status" Display="Dynamic" CssClass="error_label_red" Enabled="false"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" width="40%">
            ...
            <td>
                <table id="Table8" runat="server" cellpadding="10" cellspacing="0" width="50%">
                    <tr>
                        ...
                        <td align="left" width="60%">
                            <asp:DropDownList ID="ddl_country" runat="server" ToolTip="Country"></asp:DropDownList>
                            <asp:RequiredFieldValidator ID="rfv_country" runat="server" ErrorMessage="*Required" ControlToValidate="ddl_country" Display="Dynamic" CssClass="error_label_red" Enabled="false"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" width="40%">
                        ...
                        <td align="left" width="60%">
                            <asp:TextBox ID="txt_line1" runat="server" ToolTip="Address Line" MaxLength="50"></asp:TextBox>
                            ...
                            <asp:RequiredFieldValidator ID="rfv_line1" runat="server" ErrorMessage="*Required" ControlToValidate="txt_line1" Display="Dynamic" CssClass="error_label_red" Enabled="false"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" width="40%">
                        ...
                        <td align="left" width="60%">
                            <asp:TextBox ID="txt_line2" runat="server" ToolTip="Address Line" MaxLength="50"></asp:TextBox>
                            ...
                            <%--                            <asp:RequiredFieldValidator ID="rfv_line2" runat="server" ErrorMessage="*Required" ControlToValidate="txt_line2" Display="Dynamic" CssClass="error_label_red" Enabled="false"></asp:RequiredFieldValidator>--%>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" width="40%">
                        ...
                        <td align="left" width="60%">
                            <asp:TextBox ID="txt_city" runat="server" ToolTip="City" MaxLength="50"></asp:TextBox>
                            ...
                            <asp:RequiredFieldValidator ID="rfv_city" runat="server" ErrorMessage="*Required" ControlToValidate="txt_city" Display="Dynamic" CssClass="error_label_red" Enabled="false"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" width="40%">
                        ...
                        <td align="left" width="60%">
                            <asp:TextBox ID="txt_state" runat="server" ToolTip="State/Province" MaxLength="50"></asp:TextBox>
                            ...
                            <asp:RequiredFieldValidator ID="rfv_state" runat="server" ErrorMessage="*Required" ControlToValidate="txt_state" Display="Dynamic" CssClass="error_label_red" Enabled="false"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" width="40%">
                        ...
                        <td align="left" width="60%">
                            <asp:TextBox ID="txt_pincode" runat="server" ToolTip="Zip/Postal Code" MaxLength="50"></asp:TextBox>
                            ...
                            <asp:RequiredFieldValidator ID="rfv_pincode" runat="server" ErrorMessage="*Required" ControlToValidate="txt_pincode" Display="Dynamic" CssClass="error_label_red" Enabled="false"></asp:RequiredFieldValidator>
                ...
                <table id="Table7" runat="server" cellpadding="10" cellspacing="0" width="50%">
                    <tr>
                        ...
                        <td align="left" width="60%">
                            ...
                            <asp:RequiredFieldValidator ID="rfv_email" runat="server" ErrorMessage="*Required" ControlToValidate="txt_email" Display="Dynamic" CssClass="error_label_red" Enabled="false"></asp:RequiredFieldValidator>
                        ...
                        <td align="left" width="60%">
                            <asp:UpdatePanel ID="up_country" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <asp:RequiredFieldValidator ID="rfv_country_code" runat="server" ControlToValidate="txt_country_code" Display="Dynamic" ErrorMessage="*" CssClass="error_label_red" Enabled="false"></asp:RequiredFieldValidator>
                                    <asp:RegularExpressionValidator ID="rev_country_code" runat="server" ControlToValidate="txt_country_code" Display="Dynamic" ErrorMessage="*" ValidationExpression="^(\d{1,5})$" CssClass="error_label_orange"></asp:RegularExpressionValidator>
                                    ...
                                    <asp:RequiredFieldValidator ID="rfv_mobile" runat="server" ControlToValidate="txt_mobile" Display="Dynamic" ErrorMessage="*Required" CssClass="error_label_red" Enabled="false"></asp:RequiredFieldValidator>
                                </ContentTemplate>
                                <Triggers>
                    ...
                    <tr>
                        ...
                        <td align="left" width="60%">
                            <asp:TextBox ID="txt_landline" runat="server" ToolTip="Landline"></asp:TextBox>
        ...
        <tr align="center" style="border-bottom-style: solid; border-width: 1px; border-color: #585A59;">
            <td style="border-top-style: solid; border-width: 1px; border-color: #585A59; padding: 10px; padding-left: 20px; padding-right: 10px;">
                <asp:Button ID="btn_save_changes" runat="server" Text="Save Changes" OnClick="btn_save_changes_Click" CausesValidation="true" />
